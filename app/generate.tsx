  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch(API.generateDesign, {
        ...
        body: JSON.stringify({
          prompt: `${eventType} decoration in ${decorStyle} style. ${vision}`,
          imageUrl: imageUri ?? "",
        }),
      });
      ...
      router.push({
        pathname: "/result",
        params: { predictionId: data.predictionId, eventType, decorStyle },
      });
    } catch (e: any) {
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingSub}>
            AI is creating your personalised decoration preview…
          </Text>
          <View style={styles.loadingSteps}>
            {[
              "📸 Analysing your space photo…",
              "🎨 Applying style preferences…",
              "✨ Generating decoration preview…",
            ].map((s, i) => (
      ...
      >
        ...
        <View style={styles.generateArea}>
          <TouchableOpacity
            style={[
              styles.generateBtn,
              imageUri == null && styles.generateBtnDisabled,
            ]}
        ...
        >
          <Pressable style={styles.bottomSheet}>
            ...
            <TouchableOpacity style={styles.sheetOption} onPress={handleCamera}>
              <View
                style={[styles.sheetOptionIcon, { backgroundColor: "#E8F5E9" }]}
              >
            ...
            >
              <View
                style={[styles.sheetOptionIcon, { backgroundColor: "#FFF9E6" }]}
              >
