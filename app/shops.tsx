      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        {loading ? (
          <View style={{ padding: 40, alignItems: "center" }}>
            <Text style={{ color: Colors.textMuted }}>Loading shops...</Text>
          </View>
        ) : (
          <View style={styles.matchBanner}>
            <View
              style={[styles.matchDot, { backgroundColor: Colors.primary }]}
            />

            <Text style={styles.matchText}>
              Found <Text style={styles.matchCount}>12 shops</Text> near you
              that stock items from your{" "}
              <Text style={styles.matchLink}>Royal Wedding</Text> design.
            </Text>
          </View>
        )}
        {/* Shop cards */}
        <View style={styles.shopsList}>
          {filtered.map((shop) => (
            <View key={shop.id} style={styles.shopCard}>
              {/* Image area */}
              <View
                style={[styles.shopImage, { backgroundColor: Colors.green100 }]}
              >
              ...
              <View style={styles.shopInfo}>
                <View style={styles.shopInfoTop}>
                  <View>
                    ...
                    <Text style={styles.shopArea}>{shop.category}</Text>
                  </View>
                  <Text style={styles.shopDistance}>📍 {shop.location}</Text>
                </View>
